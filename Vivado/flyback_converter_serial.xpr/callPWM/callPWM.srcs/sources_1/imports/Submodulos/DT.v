...
module DT
  ...
  input   signed [63:0] kp_divisor_dt;  // sfix64_En32
  input   signed [63:0] ki_dt;  // sfix64_En32
  output  signed [63:0] PV_DT;  // sfix64_En16
  output  signed [63:0] MV_DT;  // sfix64_En16
  output  signed [63:0] p_action_dt;  // sfix64_En16
  output  signed [63:0] i_action_dt;  // sfix64_En16
  output  signed [63:0] error_dt;  // sfix64_En16
  ...
  wire signed [64:0] kp_dt_dtc;  // sfix65_En32
  ...
  reg signed [64:0] Divide1_c;  // sfix65
  reg signed [64:0] Divide1_div_temp;  // sfix65
  reg signed [64:0] Divide_c;  // sfix65
  reg signed [64:0] Divide_div_temp;  // sfix65
  reg signed [64:0] Divide2_c;  // sfix65
  ...
  always @(Constant_out1, Product2_out1_dtc) begin
    ...
    if (Constant_out1 == 64'sh0000000000000000) begin
      if (Product2_out1_dtc < 65'sh00000000000000000) begin
        Divide1_c = 65'sh10000000000000000;
      end
      else begin
        Divide1_c = 65'sh0FFFFFFFFFFFFFFFF;
      end
    end
    else begin
    ...
    if ((Divide1_c[64] == 1'b0) && (Divide1_c[63] != 1'b0)) begin
      SP = 64'sh7FFFFFFFFFFFFFFF;
    end
    else if ((Divide1_c[64] == 1'b1) && (Divide1_c[63] != 1'b1)) begin
  ...
  assign kp_dt_dtc = {kp_dt[63], kp_dt};



  always @(kp_divisor_dt, kp_dt_dtc) begin
    Divide_div_temp = 65'sh00000000000000000;
    if (kp_divisor_dt == 64'sh0000000000000000) begin
      if (kp_dt_dtc < 65'sh00000000000000000) begin
        Divide_c = 65'sh10000000000000000;
      end
      else begin
        Divide_c = 65'sh0FFFFFFFFFFFFFFFF;
      end
    end
    else begin
      Divide_div_temp = kp_dt_dtc / kp_divisor_dt;
      Divide_c = Divide_div_temp;
    end
    if ((Divide_c[64] == 1'b0) && (Divide_c[63] != 1'b0)) begin
      SP_1 = 64'sh7FFFFFFFFFFFFFFF;
    end
    else if ((Divide_c[64] == 1'b1) && (Divide_c[63] != 1'b1)) begin
  ...
  always @(Constant3_out1, Product3_out1_dtc) begin
    ...
    if (Constant3_out1 == 64'sh0000000000000000) begin
      if (Product3_out1_dtc < 65'sh00000000000000000) begin
        Divide2_c = 65'sh10000000000000000;
      end
      else begin
        Divide2_c = 65'sh0FFFFFFFFFFFFFFFF;
      end
    end
    else begin
      Divide2_div_temp = Product3_out1_dtc / Constant3_out1;
      Divide2_c = Divide2_div_temp;
    end
    if ((Divide2_c[64] == 1'b0) && (Divide2_c[63] != 1'b0)) begin
      SP_2 = 64'sh7FFFFFFFFFFFFFFF;
    end
    else if ((Divide2_c[64] == 1'b1) && (Divide2_c[63] != 1'b1)) begin

function RTW_Sid2UrlHash() {
	...
	/* <S1>/Add */
	this.urlHashMap["flyback_dt:79"] = "DT.v:251";
	/* <S1>/Add1 */
	this.urlHashMap["flyback_dt:83"] = "DT.v:258";
	/* <S1>/Data Type Conversion1 */
	this.urlHashMap["flyback_dt:138"] = "DT.v:314";
	/* <S1>/Data Type Conversion2 */
	this.urlHashMap["flyback_dt:139"] = "DT.v:309";
	/* <S1>/Data Type Conversion3 */
	this.urlHashMap["flyback_dt:137"] = "DT.v:324";
	/* <S1>/Data Type Conversion4 */
	this.urlHashMap["flyback_dt:140"] = "DT.v:304";
	/* <S1>/Data Type Conversion5 */
	this.urlHashMap["flyback_dt:142"] = "DT.v:319";
	/* <S1>/Discrete
Transfer Fcn2 */
	this.urlHashMap["flyback_dt:99"] = "DT.v:299";
	/* <S1>/Discrete-Time
Integrator1 */
	this.urlHashMap["flyback_dt:91"] = "DT.v:227,228,229,230,231,232,233,234,235";
	/* <S1>/Product */
	this.urlHashMap["flyback_dt:82"] = "DT.v:254,255";
	/* <S1>/Product1 */
	this.urlHashMap["flyback_dt:84"] = "DT.v:206,207";
	/* <S1>/Product3 */
	this.urlHashMap["flyback_dt:132"] = "DT.v:114,115";
	/* <S1>/Saturation */
	this.urlHashMap["flyback_dt:116"] = "DT.v:261,262,263";
	/* <S1>/Unit Delay */
	this.urlHashMap["flyback_dt:97"] = "DT.v:240,241,242,243,244,245,246,247,248";
...
function RTW_rtwnameSIDMap() {
	...
	this.rtwnameHashMap["<S1>/Product3"] = {sid: "flyback_dt:132"};
	this.sidHashMap["flyback_dt:132"] = {rtwname: "<S1>/Product3"};
	this.rtwnameHashMap["<S1>/Saturation"] = {sid: "flyback_dt:116"};
	this.sidHashMap["flyback_dt:116"] = {rtwname: "<S1>/Saturation"};
